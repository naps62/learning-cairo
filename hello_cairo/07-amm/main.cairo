...
struct AmmBatchOutput:
    ...
    # The balances of the AMM after applying_the_batch
    member token_a_after: felt
    member token_b_after: felt
    # The account Merkle roots before and after applying the batch
...
struct AmmState:
    ...
    # The ammount of the tokens currently in the AMM
...
# Compute the Merkle roots before and after the batch
# Hint argument: initial_account_dict should be a dictionary
# from accoutn_id to an address in memory of the Account struct
