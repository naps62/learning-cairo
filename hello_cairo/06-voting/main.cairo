...
struct VoteInfo:
    member voter_id: felt # The ID of the voter
    member pub_key: felt  # The voter's public key
    member vote: felt     # The vote (0 or 1)
...
struct VotingState:
    member n_yes_votes: felt # The number of "Yes" votes
    member n_no_votes: felt  # The number of "No" votes
...
# Returns a list of VoteInfo instances representing the claimed votes
# The validity of the returned data is not guaranteed and must be verified by the caller
...
func main{
    ...
    # Write the "yes" and "no" counts to the touput
    ...
    # Write th Merkle roots to the output
